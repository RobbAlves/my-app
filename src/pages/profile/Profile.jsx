      ...
      <div className="profileContainer">
        <div className="profileCenter">
          <div className="profileCenterTop">
            <img
              src={"../assets/backg.1.jpg"}
              alt="coverphoto"
              className="coverPhoto"
            />
            <button className="editCoverPhotoBtn">
              <CameraAltIcon />
              <b>Editar <span className="editPicText">Foto da capa</span></b>
            </button>
          </div>
          ...
          <div className="profileBottomLeft">
            <div className="profileUserInfo">
              ...
              <pre>
                {
                `          
     "Robson | Desenvolvedor Full Stack."
     
             `
                }
              </pre>
           
      <button type="button" className="editBioButton"><b>Editar Bio</b></button>
            </div>
